...
# Accord Protocol Template: uc-davis-standard-licensing-contract
...
```
cicero parse --template ./uc-davis-standard-licensing-contract/ --dsl ./uc-davis-standard-licensing-contract/sample.txt
...
data.json:
{
   "$class": "org.accordproject.ucDavisStandardLicensingK.MyRequest",
   "input": "World"
}
```

```
cicero execute --template ./uc-davis-standard-licensing-contract/ --dsl ./uc-davis-standard-licensing-contract/sample.txt --data ./uc-davis-standard-licensing-contract/data.json 
```
...
```
{
   ...
   "request":{
      "$class":"org.accordproject.ucDavisStandardLicensingK.Request",
      "input":"World"
   },
   "response":{
      "$class":"org.accordproject.ucDavisStandardLicensingK.Response",
