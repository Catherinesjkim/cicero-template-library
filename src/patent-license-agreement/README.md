...
# Accord Protocol Template: patent-license-agreement
...
```
cicero parse --template ./patent-license-agreement/ --dsl ./patent-license-agreement/sample.txt
...
data.json:
{
   "$class": "org.accordproject.patentlicenseagreement.MyRequest",
   "input": "World"
}
```

```
cicero execute --template ./patent-license-agreement/ --dsl ./patent-license-agreement/sample.txt --data ./patent-license-agreement/data.json 
```
...
```
{
   ...
   "request":{
      "$class":"org.accordproject.patentlicenseagreement.Request",
      "input":"World"
   },
   "response":{
      "$class":"org.accordproject.patentlicenseagreement.Response",
